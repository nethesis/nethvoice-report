/* 2 - did average duration call by DID */
...
SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did, 
...
CREATE TABLE dashboard_cdr_15_current_year AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_15_past_semester AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_15_past_quarter AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_15_past_month AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_15_current_month AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_15_past_week AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_15_current_week AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
