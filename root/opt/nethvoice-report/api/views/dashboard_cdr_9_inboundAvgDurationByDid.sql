...
CREATE TABLE dashboard_cdr_9_current_year AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_9_past_semester AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_9_past_quarter AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_9_past_month AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_9_current_month AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_9_past_week AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
...
CREATE TABLE dashboard_cdr_9_current_week AS SELECT did, Avg(avg_duration) AS avg_duration FROM
       (SELECT did,
              Avg(duration)                                                   AS avg_duration 
       FROM   ',@from,'
       WHERE  type = "IN"
