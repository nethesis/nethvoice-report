...
CREATE TABLE dashboard_cdr_16_current_year AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
...
CREATE TABLE dashboard_cdr_16_past_semester AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
...
CREATE TABLE dashboard_cdr_16_past_quarter AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
...
CREATE TABLE dashboard_cdr_16_past_month AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
...
CREATE TABLE dashboard_cdr_16_current_month AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
...
CREATE TABLE dashboard_cdr_16_past_week AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
...
CREATE TABLE dashboard_cdr_16_current_week AS
SELECT cti_group, Sum(IF(cost, cost, 0)) AS cost  FROM 
       (SELECT g.name AS cti_group, 
              Sum(cost) AS cost 
       FROM   ',@from,' c 
