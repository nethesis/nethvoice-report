...
CREATE TABLE graph_queue_position_10 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
...
CREATE TABLE graph_queue_position_15 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
...
CREATE TABLE graph_queue_position_30 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
...
CREATE TABLE graph_queue_position_60 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
