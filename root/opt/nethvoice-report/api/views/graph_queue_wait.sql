...
CREATE TABLE graph_queue_hold_10 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
...
CREATE TABLE graph_queue_hold_15 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
...
CREATE TABLE graph_queue_hold_30 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
...
CREATE TABLE graph_queue_hold_60 AS SELECT Date_format(From_unixtime(timestamp_in), "%Y-%m-%d") 
       AS 
       period, 
       qname, 
       qdescr, 
