...
/* DROPS */
DROP TABLE IF EXISTS dashboard_cdr_4_past_week;
DROP TABLE IF EXISTS dashboard_cdr_4_current_week;
DROP TABLE IF EXISTS dashboard_cdr_4_past_month;
DROP TABLE IF EXISTS dashboard_cdr_4_current_month;
DROP TABLE IF EXISTS dashboard_cdr_4_past_quarter;
DROP TABLE IF EXISTS dashboard_cdr_4_past_semester;
DROP TABLE IF EXISTS dashboard_cdr_4_past_year;
DROP TABLE IF EXISTS dashboard_cdr_4_current_year;
